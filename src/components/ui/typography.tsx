...
const typographyVariants = cva("", {
  variants: {
    variant: {
      h1: "font-caption scroll-m-20 text-3xl font-bold tracking-tight lg:text-5xl",
      h2: "font-caption scroll-m-20 pb-2 text-2xl font-semibold tracking-tight transition-colors first:mt-0",
